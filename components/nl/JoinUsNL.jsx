...
const JoinUs = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-script text-[60px] md:text-[80px] text-white text-center leading-tight">
          We kunnen niet wachten om met je te aanbidden
        </span>
      </motion.div>
      ...
      <div className="relative max-w-[1000px] mx-auto text-center">
        ...
        >
          10:30 uur — fysiek en online. <br /> Ervaar Gods aanwezigheid,
          verbind met familie, en groei in genade.
        </motion.p>
        ...
        >
          <Image
            ...
            alt="Blije gemeente die samen aanbidt in de New Creation Life Church"
