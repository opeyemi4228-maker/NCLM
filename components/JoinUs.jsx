  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1000px] mx-auto text-center">
        ...
        >
          10:30AM — in person and online. <br /> Experience God’s presence,
          connect with family, and grow in grace.
        </motion.p>
        ...
        >
          <Image
            ...
            alt="Joyful congregation worshiping together at New Creation Life Church"
            width={400}
            height={300}
