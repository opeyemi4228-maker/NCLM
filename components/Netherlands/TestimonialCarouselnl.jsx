  ...
  const testimonials = [
    {
      id: 1,
      quote:
        "Deel uitmaken van New Creation Life Church heeft mijn wandel met God volledig veranderd. Elke dienst voelt als een persoonlijke ontmoeting met Zijn aanwezigheid.",
      author: "Grace Okon",
      title: "Lid sinds 2019",
      image: "/images/testimonials/worship-bg-1.jpg",
    },
    {
      id: 2,
      quote:
        "Deze familie heeft me geleerd wat ware liefde en gemeenschap in Christus betekenen. Ik vond niet alleen een kerk, maar een thuis vol vreugde, genezing en groei.",
      author: "John Peter",
      title: "Jeugdleider",
    ...
    },
    {
      id: 3,
      quote:
        "Elke keer dat ik de dienst binnenstap, ervaar ik vrede en herstel. Ik dank God dat Hij mij met deze bediening heeft verbonden — het is werkelijk een plek van nieuwe beginnen.",
      author: "Ngozi Chukwu",
      title: "Koorlid",
    ...
    },
    {
      id: 4,
      quote:
        "New Creation Life Church heeft me geholpen mijn geloof en doel opnieuw te ontdekken. Het Woord is krachtig, praktisch en vol genade.",
      author: "David Lawrence",
      title: "Zakelijk professional",
      image: "/images/testimonials/worship-bg-4.jpg",
    },
    {
      id: 5,
      quote:
        "De warmte, eenheid en liefde in deze kerk zijn ongeëvenaard. Je kunt echt het hart van Jezus voelen in alles wat ze doen.",
      author: "Sarah James",
      title: "Afdeling Ontvangst",
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex space-x-3">
        {testimonials.map((_, index) => (
          <button
            ...
            aria-label={`Ga naar getuigenis ${index + 1}`}
          />
        ))}
      </div>
    </section>
