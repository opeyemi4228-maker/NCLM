  ...
  return (
    <section className="bg-white py-28 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          Een kerk die in Jezus gelooft, een{' '}
          <TypewriterText text="kerk die van God houdt" /> en van mensen.
        </motion.h2>
        ...
        >
          Overweldigd door de genade die we hebben ontvangen door Jezus Christus, zijn wij
          een familie vol passie voor aanbidding, geworteld in gemeenschap, en gedreven
          door een visie om Gods Koninkrijk levens over de hele aarde te zien
          transformeren.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <FeatureCard
            title="Ik Ben Nieuw"
            description="We zijn verheugd om je te verwelkomen. Laat ons je helpen jouw plek in de familie te vinden."
            cta="Plan een Bezoek"
            image={assets.welcome}
            delay={0}
          />
          <FeatureCard
            title="Maak Verbinding met een Pastor"
            description="Onze pastors staan klaar om met je mee te wandelen, te bidden en je te helpen groeien in geloof."
            cta="Verbind Nu"
            image={assets.PORTRAIT}
            delay={150}
          />
          <FeatureCard
            title="Sluit je aan bij een Groep"
            description="Waar je je ook bevindt op je geloofsreis, er is altijd een kring waar je thuis hoort."
            cta="Bekijk Groepen"
            image={assets.join}
            delay={300}
          />
