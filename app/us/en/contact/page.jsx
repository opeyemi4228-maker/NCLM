...
/*
ContactPage.jsx
- Two CTA buttons: Prayer Request and Share Testimony (open respective modal forms)
        ...
        <div className="relative z-10 flex items-center h-full px-6 md:px-20">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-3 text-gray-200 max-w-2xl">
              We'd love to hear from you — prayer requests, testimonies,
      ...
      <section className="py-12 px-6 md:px-20 bg-white text-black">
        <motion.div className="max-w-4xl mx-auto text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <p className="text-gray-800 mt-2">
            Choose an option below and fill out the short form.
          </p>
      ...
      <section className="py-12 px-6 md:px-20 bg-gray-100 text-black">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 items-start">
          <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="space-y-4">
            ...
            {/* Main Church - Houston, TX */}
            <div className="flex items-start gap-3">
              <FiMapPin size={28} className="text-red-600" />
              <div>
                <h4 className="font-semibold">Main Campus - Houston, TX</h4>
                <p className="text-gray-800">
                  1234 Church Street<br />
                  Houston, TX 77002<br />
                  United States
                </p>
              </div>
            ...
            <div className="flex items-start gap-3">
              <FiMapPin size={28} className="text-red-600" />
              <div>
                <h4 className="font-semibold">Florida Branch</h4>
                <p className="text-gray-800">
                  3201 Davie Boulevard<br />
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-1">
                {activeForm === "prayer" ? "Prayer Request" : "Share Testimony"}
              </h3>
