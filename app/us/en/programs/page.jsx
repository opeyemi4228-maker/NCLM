...
const SAMPLE_PROGRAMS = [
  {
    ...
    location: "Main Auditorium, Houston",
    summary: "Three days of revival with worship, ministry, and prophetic sessions.",
    details:
      "Join our annual revival conference with guest speakers, extended worship nights, ministry activations, and breakout sessions for pastors, families, and youth.",
    price: 0,
    capacity: 500,
  },
  {
    id: "p2",
    title: "Leadership Seminar: Team Management",
    type: "Seminar",
    start: new Date(Date.now() + 1000 * 60 * 60 * 24 * 35),
    end: new Date(Date.now() + 1000 * 60 * 60 * 24 * 35 + 1000 * 60 * 60 * 4),
    location: "Training Room A, Houston",
    summary: "Practical seminar for church leaders & volunteers.",
    details:
      "Hands-on leadership training for team building, ministry systems, and volunteer care.",
    price: 50,
    capacity: 150,
  },
  {
    ...
    location: "Youth Center, Houston",
    summary: "Weekend of worship, workshops, and outreach for youth.",
    details:
      "Music, lessons, outreach, and team-building activities for teens and young adults.",
    price: 20,
    capacity: 250,
  },
];
...
export default function ProgramsPage() {
  ...
  function submitRegistration(e) {
    ...
    alert(`Thank you! You are registered for ${registerFor.title}.`);
    setRegisterFor(null);
  }
        ...
        <div className="relative z-10 flex items-center h-full px-6 md:px-20">
          ...
          >
            ...
            <p className="mt-3 text-sm sm:text-base text-gray-200 max-w-2xl">
              Browse all current and upcoming programs. Register for conferences, seminars, training, and special ministry events.
            </p>
          </motion.div>
        </div>
      </section>
