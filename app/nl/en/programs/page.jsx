...
const SAMPLE_PROGRAMS = [
	{
		id: "p1",
		title: "Holy Spirit in Motion",
		type: "Conference",
		start: new Date(Date.now() + 1000 * 60 * 60 * 24 * 14),
		end: new Date(Date.now() + 1000 * 60 * 60 * 24 * 16),
		location: "Main Auditorium",
		summary: "HSIM is a two days program dedicated to the Person of the Holy Spirit and His ministry.",
		details:
			"The Holy Spirit is still moving and His work is continues as long as the Body of Christ is still on earth. ",
		price: 0,
		capacity: 500,
	},
	{
